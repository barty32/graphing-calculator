...
(function (Severity) {
    ...
    Severity[Severity["FATAL_ERROR"] = 3] = "FATAL_ERROR";
})(Severity || (Severity = {}));
var TokenType;
(function (TokenType) {
...
function isLParen(char) {
    return /\(|\[|\{/.test(char);
}
function isRParen(char) {
    return /\)|\]|\}/.test(char);
}
