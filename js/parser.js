...
(function (ExpressionType) {
    ...
    ExpressionType[ExpressionType["EQUATION"] = 2] = "EQUATION";
    ExpressionType[ExpressionType["INEQUALITY"] = 3] = "INEQUALITY";
    ExpressionType[ExpressionType["POLAR"] = 4] = "POLAR";
...
const functions = {
    ...
    'div': { argc: 2, type: 'arith', fn: (args) => args[0] / args[1] },
    ...
    'ln': { argc: 1, type: 'arith', fn: (args) => Math.log(args[0]) },
    'log': { argc: 1, type: 'arith', fn: (args) => Math.log10(args[0]) },
    ...
    'fac': { argc: 1, type: 'stat', fn: (args) => args[0] * gamma(args[0]) },
    //piecewise
