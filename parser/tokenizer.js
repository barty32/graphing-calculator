...
export const isLiteral = (str) => /\d|\./.test(str);
export const isChar = (str) => /[a-z]/i.test(str);
export const isOperator = (str) => /\+|\-|\*|\/|\^/.test(str);
export const isFunction = (str) => /^(sin|cos|tan|min|max|mod|sqrt|root|abs|fac|round|int)$/.test(str);
